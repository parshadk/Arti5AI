    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl w-full space-y-8">
        <div className="md:flex md:space-x-8">
          <div className="md:w-1/2 bg-white p-10 rounded-xl shadow-md mb-8 md:mb-0 bg-gradient-to-br from-blue-50 to-indigo-100">
            ...
            <div className="mt-8 flex justify-center md:justify-start space-x-6">
              ...
              <a href="https://www.instagram.com/parshad1694?igsh=MThucWtlcHh1bXJycg==" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors duration-300">
            ...
            <div className="mt-8 flex justify-center md:justify-start">
              <a
                href="https://drive.google.com/file/d/1HOpx-w7AdTnaHKEgXYQsclb_p6zgAFxV/view?usp=sharing"
                target="_blank"
          ...
          <div className="md:w-1/2 bg-white p-10 rounded-xl shadow-md bg-gradient-to-br from-purple-50 to-pink-100">
            <h2 className="text-2xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">Featured Project: Arti5AI</h2>
            <p className="text-gray-700 mb-4">
              Developed an AI-powered content generation app using Next.js, React, Tailwind CSS, TypeScript, and Google Gemini API. Focused on creating user-friendly templates and generating AI-driven content.
            </p>
            ...
            <p className="text-gray-800 font-semibold">
              Tech Stack: Next.js, React, Tailwind CSS, TypeScript, Google Gemini API, Clerk, Drizzle ORM, PostgreSQL.
            </p>
          </div>
        </div>
      </div>
